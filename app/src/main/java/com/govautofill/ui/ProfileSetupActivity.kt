...
class ProfileSetupActivity : AppCompatActivity() {
    ...
    private fun loadProfile() {
        ...
        with(binding) {
            ...
            spinnerSscGroup.setSelection(p.sscGroup)
            ...
            spinnerHscGroup.setSelection(p.hscGroup)
            ...
            spinnerGradSubject.setSelection(p.graduationSubject)
    ...
    private fun saveProfile() {
        val p = UserProfile().apply {
            with(binding) {
                ...
                sscGroup      = spinnerSscGroup.value()
                ...
                hscGroup      = spinnerHscGroup.value()
                ...
                graduationSubject    = spinnerGradSubject.value()
